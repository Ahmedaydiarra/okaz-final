 ...
 */
final class Version20230526092422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD facture_id INT NOT NULL, ADD produit_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP facture_id, DROP produit_id');
    }
}
